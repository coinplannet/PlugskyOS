...
} from "@plugsky/plugin/tui"
import { AttentionSoundName, type TuiConfig } from "./config"
import { Schema } from "effect"
import stripAnsi from "strip-ansi"
import * as TuiAudio from "./audio"
import defaultSoundPath from "@plugsky/ui/audio/bip-bop-01.mp3" with { type: "file" }
import questionSoundPath from "@plugsky/ui/audio/bip-bop-03.mp3" with { type: "file" }
import permissionSoundPath from "@plugsky/ui/audio/staplebops-06.mp3" with { type: "file" }
import errorSoundPath from "@plugsky/ui/audio/nope-03.mp3" with { type: "file" }
import doneSoundPath from "@plugsky/ui/audio/bip-bop-01.mp3" with { type: "file" }
import subagentDoneSoundPath from "@plugsky/ui/audio/yup-01.mp3" with { type: "file" }
