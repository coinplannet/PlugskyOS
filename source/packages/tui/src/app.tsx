...
import { Global } from "@plugsky/core/global"
import { Flag } from "@plugsky/core/flag/flag"
import { InstallationVersion } from "@plugsky/core/installation/version"
...
function App(props: { onSnapshot?: () => Promise<string[]>; pluginHost: TuiPluginHost }) {
  ...
  createEffect(() => {
    ...
    if (route.data.type === "home") {
      renderer.setTerminalTitle("Plugsky OS")
      return
    }
  ...
  event.on("installation.update-available", async (evt) => {
    ...
    await DialogAlert.show(
      dialog,
      "Update Complete",
      `Successfully updated to Plugsky OS v${result.data.version}. Please restart the application.`,
    )
