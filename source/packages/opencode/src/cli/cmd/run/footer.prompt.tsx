...
import { normalizePromptContent } from "@plugsky/tui/editor"
...
import { OPENCODE_BASE_MODE, useBindings } from "@plugsky/tui/keymap"
...
export function createPromptState(input: PromptInput): PromptState {
  ...
  const slashOptions = createMemo<SlashOption[]>(() => {
    const builtins = [
      ...
      { kind: "slash", name: "exit", display: "/exit", description: "close Plugsky OS" } satisfies SlashOption,
    ]
